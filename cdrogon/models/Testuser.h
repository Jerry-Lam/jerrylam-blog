...
class Testuser
{
  public:
     ...
     */
    explicit Testuser(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Testuser(const Json::Value &pJson) noexcept(false);
     ...
     */
    Testuser(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Testuser>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Testuser>;
#endif
